      ...
      <div className="flex flex-col gap-4 pt-2">
        <div className="flex flex-col space-y-2 w-full md:items-center md:gap-x-8 md:flex-row">
          ...
          <div className="flex flex-col grow max-w-lg">
            <h1 className="text-2xl leading-10 font-medium text-greeting">Hey, I&apos;m Liav 👋</h1>
            <h2 className="text-lg leading-6 font-normal text-description">
              Lifelong learner, building digital experiences.
            </h2>

            <a
              href="http://mailto:liavedry@gmail.com"
              className="btn btn-md mt-4 btn-primary btn-block rounded-full text-white"
            >
        ...
        <div className="my-6 md:my-8 w-full ">
          <h3 className="text-xl md:text-3xl md:mb-2 font-medium">Writing</h3>
