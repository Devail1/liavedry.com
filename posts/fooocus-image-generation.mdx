...
![A close-up of a human eye with a black pupil and a blue iris. Raindrops are visible on the flower petals and the eye.](https://res.cloudinary.com/di41jhirl/image/upload/v1711423353/creative-focus_xcywmc.png 'Image created with Fooocus just by typing "creative focus"')
...
Head over to the [Fooocus GitHub page](https://github.com/lllyasviel/Fooocus) to download the software. The download itself is manageable (around 2GB), but keep in mind the extracted folder and models will require more space (up to 24GB).
